        ...
        $(document).ready(function(){
            $('#publish').click(function(){
                $.ajax({
                    ...
                    method: 'post',
                    data: { texto: $('#floatingTextarea').val() },
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100" >
                    ...
                    <a href="add" class="nav-item nav-link Pur active"><i class="fa-solid fa-pen-to-square me-2"></i>Publicar</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" maxlength="140" placeholder="Como está se sentindo hoje?" name="content" id="floatingTextarea" style="height: 150px;"></textarea>
                    </div>
                        <div class="bg-secondary">
                            <button type="submit" class="btn btn-primary py-3 b-4" id="publish">Ir!<i style="margin-left:5px;
                                 font-size:20px"class="bi bi-arrow-right-circle"></i></button>
                        </div>
                        <div class="bg-secondary" id="resultado">
                        </div>
                </div>
            </div>
            <!-- Recent Sales End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center p-4">
                        ...
                        <p class="mb-4">Como esse site é apenas um exemplo, você pode publicar até <strong>5</strong> posts de <strong>140</strong> caracteres no máximo.</p>
                    </div>
                </div>
            </div>
            <!-- Message End -->
