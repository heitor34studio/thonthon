...
<head>
    <meta charset="utf-8">
    <title>Thonthon - Pesquisar</title>
            ...
            $(document).ready(function(){
                $('#search').keyup(function(){
                    $.ajax({
                        ...
                        method: 'post',
                        data: { search: $('#search').val(), option: $('input[name=gridRadios]:checked').val() },
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100" >
                    ...
                    <a href="search" class="nav-item nav-link Blue active"><i class="fa-solid fa-magnifying-glass me-2"></i>Pesquisar</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Formulário de Pesquisa</h6>
                        <div class="input-group mb-3">
                            <input maxlength="200" type="text" class="form-control" placeholder="Pesquise algo por aqui:"
                            aria-label="Recipient's username" aria-describedby="basic-addon2" name="search" id="search">
                        </div>
                        <fieldset class="row mb-3">
                            <legend class="col-form-label col-sm-2 pt-0">Tipos:</legend>
                            <div class="col-sm-10">
